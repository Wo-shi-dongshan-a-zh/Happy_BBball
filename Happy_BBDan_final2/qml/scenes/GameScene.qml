...
Scene {
    ...
    Connections {//接受关卡中的信号
        ...
        onGameOver: {
            ...
            loader.item.takeback.visible=false
        ...
        onEndlessGameOver:{
            vectory_wow.play()
            vectory_applause_timer.start()
            endlessgameoverUI.visible=true
            loader.item.takeback.visible=false
        }
    ...
    Rectangle {
        ...
        GameButton {//退出确认按钮
            ...
            onClicked: {
                ...
                resetgameButton.enabled = true
                if(activeLevelFileName==="endless.qml"){
                    backModelChooseUI()
                    loader.item.destroy_boxes()//删除动态创建的实体Boxes
                }else{
                    backSelectUI()
                }
            }
    ...
    Rectangle {
        ...
        GameButton {
            ...
            width: 200
            onClicked: {
                endlessgameoverUI.visible = false
